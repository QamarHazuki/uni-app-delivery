...
import type { InputNumberBoxEvent } from '@/components/vk-data-input-number-box/vk-data-input-number-box.ts'
...
const onChangeCount = (ev: InputNumberBoxEvent) => {
    putMemberCartBySkuIdAPI(String(ev.index!), { count: ev.value })
}
    ...
    <scroll-view enable-back-to-top scroll-y class="scroll-view" @scrolltolower="onScrolltolower">
        ...
        <template v-if="memberStore.profile">
            ...
            <view class="cart-blank" v-else>
                ...
                <navigator url="/pages/food/index" hover-class="none">
