...
import type {
    ...
    SkuPopupInstance,
    SkuPopupLocaldata,
} from '@/components/vk-data-goods-sku-popup/vk-data-goods-sku-popup.d'
import { postMemberCartAPI } from '@/service/cart.ts'
import { getGoodsByIdAPI } from '@/service/goods.ts'
