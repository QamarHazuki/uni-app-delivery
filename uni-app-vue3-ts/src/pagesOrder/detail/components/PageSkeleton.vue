    ...
    <view class="sk-container">
        <scroll-view :scroll-y="true" class="viewport sk-transparent" id="scroller" :enable-back-to-top="true">
            ...
            <view class="goods">
                <view class="item">
                    <navigator class="navigator" hover-class="none">
                        ...
                        <view class="meta">
                            <view class="name ellipsis sk-transparent sk-text-14-2857-474 sk-text">厚厚一按就干爽，埃及进口长绒棉毛巾
                            </view>
                    ...
                    <navigator class="navigator" hover-class="none">
                        <image class="cover sk-image"></image>
                        <view class="meta">
                            <view class="name ellipsis sk-transparent sk-text-14-2857-969 sk-text">KJE金属色系轻量电动车骑行盔男女通用
                            </view>
                    ...
                    <navigator class="navigator" hover-class="none">
                        <image class="cover sk-image"></image>
                        <view class="meta">
                            <view class="name ellipsis sk-transparent sk-text-14-2857-130 sk-text">源自澳洲进口羊毛，儿童奢暖羊毛被升级款
                            </view>
                            <view class="type sk-transparent sk-text-22-2222-110 sk-text">春秋款，
                                100%羊毛款：150x200cm，适合1.2米/1.35米床</view>
                            <view class="price">
                                <view class="actual">
                                    <text class="symbol sk-transparent sk-opacity">¥</text>
                ...
                <view class="total">
                    <view class="row">
                        ...
                        <view class="symbol sk-transparent sk-text-0-0000-998 sk-text sk-pseudo sk-pseudo-circle">477
                        </view>
                    </view>
                    <view class="row">
                        <view class="text sk-transparent sk-text-0-0000-912 sk-text">运费: </view>
                        <view class="symbol sk-transparent sk-text-0-0000-208 sk-text sk-pseudo sk-pseudo-circle">2
                        </view>
                    </view>
                    <view class="row">
            ...
            <view class="toolbar" style="padding-bottom: 34px">
                <view class="button primary sk-transparent sk-text-31-9444-411 sk-text"
                    style="background-position-x: 50%">再次购买</view>
            </view>
        </scroll-view>
    </view>
</template>
...
.sk-text-22-2222-237 {
    background-image: linear-gradient(transparent 22.2222%,
            #eeeeee 0%,
            #eeeeee 77.7778%,
            transparent 0%) !important;
...
.sk-text-31-9444-411 {
    background-image: linear-gradient(transparent 31.9444%,
            #eeeeee 0%,
            #eeeeee 68.0556%,
            transparent 0%) !important;
